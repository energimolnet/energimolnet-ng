...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobots","emSubaccounts","emDateUtil","energimolnetAPI",function(e,n,o,s,t,m,i,r,u,c,l,p,a,C,f,w,R){function g(n,o){n.then(function(n){o===!0?e.console.log("Response:\n",n):e.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){e.console.log("Error:\n",n)})}g.Accounts=n,g.Clients=o,g.ConsumptionPreview=s,g.ConsumptionStats=t,g.Consumptions=m,g.Contracts=i,g.Meters=u,g.Me=r,g.Owners=c,g.Password=l,g.RefreshTokens=p,g.Reports=a,g.Robots=C,g.Subaccounts=f,g.DateUtil=w,g.api=R,e.em=g}])};
