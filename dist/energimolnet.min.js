...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobots","emSubaccounts","emDateUtil","energimolnetAPI",function(e,n,o,s,t,m,i,u,r,c,l,p,a,f,w,C){function R(n,o){n.then(function(n){o===!0?e.console.log("Response:\n",n):e.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){e.console.log("Error:\n",n)})}R.Accounts=n,R.Clients=o,R.ConsumptionPreview=s,R.ConsumptionStats=t,R.Consumptions=m,R.Meters=u,R.Me=i,R.Owners=r,R.Password=c,R.RefreshTokens=l,R.Reports=p,R.Robots=a,R.Subaccounts=f,R.DateUtil=w,R.api=C,e.em=R}])};


},{}],3:[function(require,module,exports){
module.exports=function(t){t.factory("energimolnetAPI",["$http","$window","$q",function(t,a,n){function i(a){return n(function(n,i){t(u(a)).then(function(t){n(null==t.data.count||null==t.data.limit||null==t.data.skip?t.data.data:{data:t.data.data,pagination:{skip:t.data.skip,limit:t.data.limit,count:t.data.count,page:1+t.data.skip/t.data.limit,from:t.data.skip+1,to:t.data.skip+t.data.limit>t.data.count?t.data.count:t.data.skip+t.data.limit}})},function(t){401===t.status&&e(void 0),i(null!=t.data?t.data.errors:{})})})}function o(){return a.localStorage.getItem(l)}function e(t){null!=t&&t.length>0?a.localStorage.setItem(l,t):a.localStorage.removeItem(l)}function u(t){var a=o();return null!=a&&(t.headers={Authorization:"OAuth "+a}),t}var l="energimolnetApiToken";return{getToken:o,setToken:e,request:i}}])};


},{}],4:[function(require,module,exports){
!function(e){var r=e.module("energimolnet",[]);require("./resource-factory")(r),require("./url")(r),require("./energimolnet-api")(r),require("./debug-util")(r),require("./date-util")(r),require("./models/accounts")(r),require("./models/clients")(r),require("./models/consumption-preview")(r),require("./models/consumption-stats")(r),require("./models/consumptions")(r),require("./models/me")(r),require("./models/meters")(r),require("./models/owners")(r),require("./models/password")(r),require("./models/refreshtokens")(r),require("./models/reports")(r),require("./models/robots")(r),require("./models/subaccounts")(r)}(angular);
...
module.exports=function(e){e.factory("emMeters",["emResourceFactory","energimolnetAPI","emUrl",function(e,r,t){function n(e){return function(n,a){for(var o=[],s=n.length,u=a.length,m=0;s>m;m++)for(var l=n[m],h=0;u>h;h++){var i=a[h];o.push({_id:l,holder:i})}return r.request({url:t.url(e),method:"POST",data:o})}}var a=e({"default":"/meters"},["get","query","save","delete","batchUpdate"]);return a.assign=n("/meters/many/assign_to"),a.share=n("/meters/many/share_with"),a}])};
...
module.exports=function(t){t.factory("emResourceFactory",["emUrl","energimolnetAPI",function(t,e){function r(t,e,r){function s(){this.getPath=t.get||t["default"],this.queryPath=t.query||t["default"],this.savePath=t.save||t["default"],this.deletePath=t["delete"]||t["default"],this.batchUpdatePath=t.batchUpdate||t["default"],this.options=r}return r=r||{},e.indexOf("get")>-1&&(s.prototype.get=o),e.indexOf("query")>-1&&(s.prototype.query=n),e.indexOf("save")>-1&&(s.prototype.save=a),e.indexOf("batchUpdate")>-1&&(s.prototype.batchUpdate=u),e.indexOf("delete")>-1&&(s.prototype["delete"]=i),void 0!==r.forAccountPath&&(s.prototype.forAccount=h),new s}function o(r){return e.request({method:"GET",url:t.url([this.getPath,r])})}function a(r){var o,a,u=r;return void 0!==r._id||"PUT"===this.options.saveMethod?(a=[this.savePath,r._id],o="PUT",u=angular.copy(r),delete u._id):(o="POST",a=[this.savePath]),e.request({method:o,url:t.url(a),data:u})}function u(r,o){for(var a=[],u=0,n=r.length;n>u;u++){var i=angular.copy(o);i._id=r[u],a.push(i)}return e.request({method:"PUT",url:t.url([this.batchUpdatePath]),data:a})}function n(r){return e.request({method:"GET",url:t.url(this.queryPath),params:s(r)})}function i(r){return e.request({method:"DELETE",url:t.url([this.deletePath,r])})}function h(t){var e={"default":"/accounts/"+t+"/"+this.options.forAccountPath};return r(e,this.options.forAccountMethods)}function s(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var o=t[r],a=angular.isString(o);null!=o&&(a&&o.length>0||!a)&&(e[r]=o)}return e}return r}])};
