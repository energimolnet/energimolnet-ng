...
module.exports=function(e){e.factory("emMeters",["emResourceFactory","energimolnetAPI","emUrl",function(e,r,t){function n(e){return function(n,a){for(var s=[],u=n.length,o=a.length,m=0;u>m;m++)for(var l=n[m],c=0;o>c;c++){var d=a[c];s.push({_id:l,holder:d})}return r.request({url:t.url(e),method:"POST",data:s})}}var a=e({"default":"/meters"},["get","query","save","delete","batchUpdate"]);return a.assign=n("/meters/many/assign"),a.share=n("/meters/many/share"),a}])};
