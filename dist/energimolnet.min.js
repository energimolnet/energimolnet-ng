...
module.exports=function(o,s,e,n,t,i,c,l,r,u,p,a,b,C,d,f,m,R,M,S,g,J,h,w,F,k,E,O){function P(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}P.Accounts=s,P.Clients=e,P.Complaints=n,P.CalculatedMetrics=t,P.ConsumptionPreview=i,P.ConsumptionStats=c,P.Consumptions=l,P.EdielJobs=r,P.Feeds=u,P.FileJobs=p,P.FtpConnections=a,P.Me=b,P.Meters=C,P.MetricModels=d,P.Owners=f,P.Password=m,P.RefreshTokens=R,P.Reports=M,P.RobotJobs=S,P.Robots=g,P.Scrapers=J,P.Subaccounts=h,P.Subscribers=w,P.Tokens=F,P.DateUtil=k,P.api=E,P.auth=O,o.em=P};
