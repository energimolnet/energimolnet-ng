...
module.exports=function(o,s,e,n,t,i,c,l,r,u,p,a,b,R,d,f,C,S,m,M,g,J,h,F,k,w,A,E,O){function T(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}T.Accounts=s,T.Apps=e,T.Clients=n,T.Complaints=t,T.CalculatedMetrics=i,T.ConsumptionStats=c,T.Consumptions=l,T.EdielJobs=r,T.Feeds=u,T.FileJobs=p,T.FtpConnections=a,T.Me=b,T.Meters=R,T.MetricModels=d,T.Owners=f,T.Password=C,T.RefreshTokens=S,T.Reports=m,T.RobotJobs=M,T.RobotStats=g,T.Robots=J,T.Scrapers=h,T.Subaccounts=F,T.Subscribers=k,T.Tokens=w,T.DateUtil=A,T.api=E,T.auth=O,o.em=T};
...
module.exports=function(t){return t({"default":"/stats/robots",get:!1,query:!0,put:!1,post:!1,"delete":!1,forAccount:{"default":"stats/robots",get:!0}})};
