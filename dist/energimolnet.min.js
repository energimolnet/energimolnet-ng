...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobots","emUsers","emSubaccounts","emDateUtil","energimolnetAPI",function(e,n,o,s,t,m,r,i,u,c,l,p,a,C,f,w,R,g){function P(n,o){n.then(function(n){o===!0?e.console.log("Response:\n",n):e.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){e.console.log("Error:\n",n)})}P.Accounts=n,P.Clients=o,P.ConsumptionPreview=s,P.ConsumptionStats=t,P.Consumptions=m,P.Contracts=r,P.Meters=u,P.Me=i,P.Owners=c,P.Password=l,P.RefreshTokens=p,P.Reports=a,P.Robots=C,P.Subaccounts=w,P.Users=f,P.DateUtil=R,P.api=g,e.em=P}])};
