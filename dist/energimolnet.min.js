...
module.exports=function(o,s,e,n,t,i,c,l,r,u,a,p,b,R,S,d,f,C,M,m,g,J,h,F,k,w,A,E,O,T){function x(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}x.Accounts=s,x.Apps=e,x.Clients=n,x.Complaints=t,x.CalculatedMetrics=i,x.ConsumptionStats=c,x.Consumptions=l,x.EdielJobs=r,x.Feeds=u,x.FileJobs=a,x.FtpConnections=p,x.Me=b,x.Meters=R,x.MeterStats=S,x.MetricModels=d,x.Owners=f,x.Password=C,x.RefreshTokens=M,x.Reports=m,x.RobotJobs=g,x.RobotStats=J,x.Robots=h,x.Scrapers=F,x.Subaccounts=k,x.Subscribers=w,x.Tokens=A,x.DateUtil=E,x.api=O,x.auth=T,o.em=x};
...
module.exports=function(e){var t=e({"default":"/accounts",get:!0,query:!0,put:!0,post:!0,"delete":!0});return t.exists=e({"default":"/acccounts/exists",get:!1,query:!0,put:!1,post:!1,"delete":!1}),t};
