...
module.exports=function(t){t.factory("emResourceFactory",["emUrl","energimolnetAPI",function(t,e){function r(t,e,r){function s(){this.getPath=t.get||t["default"],this.queryPath=t.query||t["default"],this.savePath=t.save||t["default"],this.deletePath=t["delete"]||t.get||t["default"],this.options=r}return r=r||{},e.indexOf("get")>-1&&(s.prototype.get=n),e.indexOf("query")>-1&&(s.prototype.query=u),e.indexOf("save")>-1&&(s.prototype.save=o),e.indexOf("delete")>-1&&(s.prototype["delete"]=a),null!=r.forAccountPath&&(s.prototype.forAccount=i),new s}function n(r){return e.request({method:"GET",url:t.url([this.getPath,r])})}function o(r){var n,o,u=r;return null!=r._id||"PUT"==this.options.saveMethod?(o=[this.savePath,r._id],n="PUT",u=angular.copy(r),delete u._id):(n="POST",o=[this.savePath]),e.request({method:n,url:t.url(o),data:u})}function u(r){return e.request({method:"GET",url:t.url(this.queryPath),params:s(r)})}function a(r){return e.request({method:"DELETE",url:t.url([this.deletePath,r])})}function i(t){var e={"default":"/accounts/"+t+"/"+this.options.forAccountPath};return r(e,this.options.forAccountMethods)}function s(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var n=t[r],o=angular.isString(n);null!=n&&(o&&n.length>0||!o)&&(e[r]=n)}return e}return r}])};
