...
module.exports=function(o,s,n,e,t,i,c,r,l,u,p,a,b,f,C,R,d,m,M,S,g,J,h,w,k,E){function F(s,n){s.then(function(s){n===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}F.Accounts=s,F.Clients=n,F.CalculatedMetrics=e,F.ConsumptionPreview=t,F.ConsumptionStats=i,F.Consumptions=c,F.EdielJobs=r,F.FileJobs=l,F.FtpConnections=u,F.Me=p,F.Meters=a,F.MetricModels=b,F.Owners=f,F.Password=C,F.RefreshTokens=R,F.Reports=d,F.RobotJobs=m,F.Robots=M,F.Scrapers=S,F.Subaccounts=g,F.Subscribers=J,F.Tokens=h,F.DateUtil=w,F.api=k,F.auth=E,o.em=F};
