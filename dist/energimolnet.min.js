...
module.exports=function(e){e.factory("emRobots",["emResourceFactory","energimolnetAPI",function(e,t){var o=e({"default":"/robots"},["get","query","save","delete"]);return o.run=function(e){t.request({url:this.getPath+"/"+e+"run",method:"POST"})},o}])};
