...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emEdielJobs","emFileJobs","emFtpConnections","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobotJobs","emRobots","emSubaccounts","emSubscribers","emTokens","emDateUtil","energimolnetAPI",function(e,o,n,s,t,i,m,r,u,c,l,b,p,C,R,a,f,w,J,S,d,g){function P(o,n){o.then(function(o){n===!0?e.console.log("Response:\n",o):e.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){e.console.log("Error:\n",o)})}P.Accounts=o,P.Clients=n,P.ConsumptionPreview=s,P.ConsumptionStats=t,P.Consumptions=i,P.EdielJobs=m,P.FileJobs=r,P.FtpConnections=u,P.Meters=l,P.Me=c,P.Owners=b,P.Password=p,P.RefreshTokens=C,P.Reports=R,P.RobotJobs=a,P.Robots=f,P.Subaccounts=w,P.Subscribers=J,P.Tokens=S,P.DateUtil=d,P.api=g,e.em=P}])};
...
module.exports=function(t){t.factory("emConsumptionStats",["emResourceFactory",function(t){return t({"default":"/accounts/me/consumption_stats"},["get"],{forAccountPath:"consumption_stats",forAccountMethods:["get"]})}])};


},{}],9:[function(require,module,exports){
module.exports=function(o){o.factory("emConsumptions",["emResourceFactory","energimolnetAPI","emUrl",function(o,t,r){var e=o({"default":"/consumptions"},[],{forAccountPath:"consumptions",forAccountMethods:"save",forAccountOptions:{saveMethod:"PUT"}});return e.get=function(o,e,n,u){return u=u||["energy"],u=angular.isArray(u)?u:[u],n=angular.isArray(n)?n:[n],t.request({method:"GET",url:r.url([this.getPath,o,e,n.join("+")]),params:{metrics:u.join(",")}})},e}])};
...
module.exports=function(t){t.factory("emSubaccounts",["emResourceFactory",function(t){return t({},[],{forAccountPath:"subaccounts",forAccountMethods:["get","save","query","delete"],forAccountPaths:{get:"/accounts","delete":"/accounts"}})}])};


},{}],22:[function(require,module,exports){
module.exports=function(e){e.factory("emSubscribers",["emResourceFactory",function(e){return e({},[],{forAccountPath:"meter_subscribers",forAccountMethods:["get","save","query","delete"]})}])};


},{}],23:[function(require,module,exports){
module.exports=function(e){e.factory("emTokens",["emResourceFactory",function(e){return e({},[],{forAccountPath:"tokens",forAccountMethods:["get","save","query","delete"]})}])};


},{}],24:[function(require,module,exports){
module.exports=function(t){t.factory("emResourceFactory",["emUrl","energimolnetAPI",function(t,e){function r(t,e,r){function s(){this.getPath=t.get||t["default"],this.queryPath=t.query||t["default"],this.savePath=t.save||t["default"],this.deletePath=t["delete"]||t["default"],this.batchUpdatePath=t.batchUpdate||t["default"],this.options=r}return r=r||{},e.indexOf("get")>-1&&(s.prototype.get=o),e.indexOf("query")>-1&&(s.prototype.query=u),e.indexOf("save")>-1&&(s.prototype.save=a),e.indexOf("batchUpdate")>-1&&(s.prototype.batchUpdate=n),e.indexOf("delete")>-1&&(s.prototype["delete"]=i),void 0!==r.forAccountPath&&(s.prototype.forAccount=h),new s}function o(r){return e.request({method:"GET",url:t.url([this.getPath,r])})}function a(r){var o,a,n=r;return void 0!==r._id||"PUT"===this.options.saveMethod?(a=[this.savePath,r._id],o="PUT",n=angular.copy(r),delete n._id):(o="POST",a=[this.savePath]),e.request({method:o,url:t.url(a),data:n})}function n(r,o){for(var a=[],n=0,u=r.length;u>n;n++){var i=angular.copy(o);i._id=r[n],a.push(i)}return e.request({method:"PUT",url:t.url([this.batchUpdatePath]),data:a})}function u(r){return e.request({method:"GET",url:t.url(this.queryPath),params:s(r)})}function i(r){return e.request({method:"DELETE",url:t.url([this.deletePath,r])})}function h(t){var e=angular.copy(this.options.forAccountPaths)||{};return void 0===e["default"]&&(e["default"]="/accounts/"+t+"/"+this.options.forAccountPath),r(e,this.options.forAccountMethods,this.options.forAccountOptions)}function s(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var o=t[r],a=angular.isString(o);null!=o&&(a&&o.length>0||!a)&&(e[r]=o)}return e}return r}])};
