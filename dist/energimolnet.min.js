...
module.exports=function(o,s,e,n,t,i,c,l,r,u,a,p,b,C,R,d,f,m,S,M,g,J,h,w,F,k,E,O,P){function T(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}T.Accounts=s,T.Clients=e,T.Complaints=n,T.CalculatedMetrics=t,T.ConsumptionPreview=i,T.ConsumptionStats=c,T.Consumptions=l,T.EdielJobs=r,T.Feeds=u,T.FileJobs=a,T.FtpConnections=p,T.Me=b,T.Meters=C,T.MetricModels=R,T.Owners=d,T.Password=f,T.RefreshTokens=m,T.Reports=S,T.RobotJobs=M,T.RobotStats=g,T.Robots=J,T.Scrapers=h,T.Subaccounts=w,T.Subscribers=F,T.Tokens=k,T.DateUtil=E,T.api=O,T.auth=P,o.em=T};
