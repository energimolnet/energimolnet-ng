...
module.exports=function(t){t.factory("emResourceFactory",["emUrl","energimolnetAPI",function(t,e){function r(t,e,r){function s(){this.getPath=t.get||t["default"],this.queryPath=t.query||t["default"],this.savePath=t.save||t["default"],this.deletePath=t["delete"]||t.get||t["default"],this.options=r}return r=r||{},e.indexOf("get")>-1&&(s.prototype.get=n),e.indexOf("query")>-1&&(s.prototype.query=o),e.indexOf("save")>-1&&(s.prototype.save=u),e.indexOf("delete")>-1&&(s.prototype["delete"]=a),null!=r.forAccountPath&&(s.prototype.forAccount=i),new s}function n(r){return e.request({method:"GET",url:t.url([this.getPath,r])})}function u(r){var n,u,o=r;return null!=r._id||"PUT"==this.options.saveMethod?(u=[this.savePath,r._id],n="PUT",o=angular.copy(r),delete o._id):(n="POST",u=[this.savePath]),e.request({method:n,url:t.url(u),data:o})}function o(r){return e.request({method:"GET",url:t.url(this.queryPath),params:s(r)})}function a(r){return e.request({method:"DELETE",url:t.url([this.deletePath,r])})}function i(e){var n={"default":t.url(["/accounts",e,this.options.forAccountPath])};return r(n,this.options.forAccountMethods)}function s(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var n=t[r],u=angular.isString(n);null!=n&&(u&&n.length>0||!u)&&(e[r]=n)}return e}return r}])};
