...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emEdielJobs","emFileJobs","emFtpConnections","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobotJobs","emRobots","emUsers","emSubaccounts","emTokens","emDateUtil","energimolnetAPI",function(e,o,n,s,t,m,i,r,c,u,l,p,b,C,a,R,f,w,J,d,g,P,S){function k(o,n){o.then(function(o){n===!0?e.console.log("Response:\n",o):e.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){e.console.log("Error:\n",o)})}k.Accounts=o,k.Clients=n,k.ConsumptionPreview=s,k.ConsumptionStats=t,k.Consumptions=m,k.Contracts=i,k.EdielJobs=r,k.FileJobs=c,k.FtpConnections=u,k.Meters=p,k.Me=l,k.Owners=b,k.Password=C,k.RefreshTokens=a,k.Reports=R,k.RobotJobs=f,k.Robots=w,k.Subaccounts=d,k.Tokens=g,k.Users=J,k.DateUtil=P,k.api=S,e.em=k}])};
