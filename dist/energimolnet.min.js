...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emMe","emOwners","emPassword","emRefreshTokens","emReports","emRobots","emSubaccounts","emUsers","emDateUtil","energimolnetAPI",function(e,n,o,s,t,m,i,r,u,c,l,p,a,C,f,w,R){function g(n,o){n.then(function(n){1==o?e.console.log("Response:\n",n):e.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){e.console.log("Error:\n",n)})}g.Accounts=n,g.Clients=o,g.ConsumptionPreview=s,g.ConsumptionStats=t,g.Consumptions=m,g.Contracts=i,g.Me=r,g.Owners=u,g.Password=c,g.RefreshTokens=l,g.Reports=p,g.Robots=a,g.Subaccounts=C,g.Users=f,g.DateUtil=w,g.api=R,e.em=g}])};
...
module.exports=function(e){e.factory("emContracts",["emResourceFactory",function(e){return e({"default":"/contracts"},["get","query","save","delete","batchUpdate"])}])};
...
module.exports=function(t){t.factory("emResourceFactory",["emUrl","energimolnetAPI",function(t,e){function r(t,e,r){function s(){this.getPath=t.get||t["default"],this.queryPath=t.query||t["default"],this.savePath=t.save||t["default"],this.deletePath=t["delete"]||t.get||t["default"],this.batchUpdatePath=t.batchUpdate||t["default"],this.options=r}return r=r||{},e.indexOf("get")>-1&&(s.prototype.get=u),e.indexOf("query")>-1&&(s.prototype.query=o),e.indexOf("save")>-1&&(s.prototype.save=a),e.indexOf("batchUpdate")>-1&&(s.prototype.batchUpdate=n),e.indexOf("delete")>-1&&(s.prototype["delete"]=h),null!=r.forAccountPath&&(s.prototype.forAccount=i),new s}function u(r){return e.request({method:"GET",url:t.url([this.getPath,r])})}function a(r){var u,a,n=r;return null!=r._id||"PUT"==this.options.saveMethod?(a=[this.savePath,r._id],u="PUT",n=angular.copy(r),delete n._id):(u="POST",a=[this.savePath]),e.request({method:u,url:t.url(a),data:n})}function n(r,u){for(var a=[],n=0,o=r.length;o>n;n++){var h=angular.copy(u);h._id=r[n],a.push(h)}return e.request({method:"PUT",url:t.url([this.batchUpdatePath]),data:a})}function o(r){return e.request({method:"GET",url:t.url(this.queryPath),params:s(r)})}function h(r){return e.request({method:"DELETE",url:t.url([this.deletePath,r])})}function i(t){var e={"default":"/accounts/"+t+"/"+this.options.forAccountPath};return r(e,this.options.forAccountMethods)}function s(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var u=t[r],a=angular.isString(u);null!=u&&(a&&u.length>0||!a)&&(e[r]=u)}return e}return r}])};
