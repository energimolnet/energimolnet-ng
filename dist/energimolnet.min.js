...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emFtpConnections","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobotJobs","emRobots","emUsers","emSubaccounts","emDateUtil","energimolnetAPI",function(e,o,n,s,t,m,i,r,c,u,l,p,C,a,R,b,f,w,g,P){function S(o,n){o.then(function(o){n===!0?e.console.log("Response:\n",o):e.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){e.console.log("Error:\n",o)})}S.Accounts=o,S.Clients=n,S.ConsumptionPreview=s,S.ConsumptionStats=t,S.Consumptions=m,S.Contracts=i,S.FtpConnections=r,S.Meters=u,S.Me=c,S.Owners=l,S.Password=p,S.RefreshTokens=C,S.Reports=a,S.RobotJobs=R,S.Robots=b,S.Subaccounts=w,S.Users=f,S.DateUtil=g,S.api=P,e.em=S}])};
...
module.exports=function(e){e.factory("emRobotJobs",["emResourceFactory",function(e){return e({"default":"/robotjobs"},["get","query","save","delete"])}])};
