...
module.exports=function(t){t.factory("emSubaccounts",["emResourceFactory",function(t){var c=t({"default":"/accounts"},["get","query","save","delete"]);c.forAccount=function(t){return this.queryPath=this.getPath="/accounts/"+t+"/subaccounts",this}}])};
