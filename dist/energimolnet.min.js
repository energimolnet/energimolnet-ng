...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emEdielJobs","emFileJobs","emFtpConnections","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobotJobs","emRobots","emSubaccounts","emTokens","emDateUtil","energimolnetAPI",function(e,o,n,s,t,i,m,u,r,c,l,p,b,C,R,a,f,w,J,d,g){function P(o,n){o.then(function(o){n===!0?e.console.log("Response:\n",o):e.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){e.console.log("Error:\n",o)})}P.Accounts=o,P.Clients=n,P.ConsumptionPreview=s,P.ConsumptionStats=t,P.Consumptions=i,P.EdielJobs=m,P.FileJobs=u,P.FtpConnections=r,P.Meters=l,P.Me=c,P.Owners=p,P.Password=b,P.RefreshTokens=C,P.Reports=R,P.RobotJobs=a,P.Robots=f,P.Subaccounts=w,P.Tokens=J,P.DateUtil=d,P.api=g,e.em=P}])};
