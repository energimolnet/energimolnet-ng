...
module.exports=function(t){t.factory("emConsumptions",["emResourceFactory","energimolnetAPI","emUrl",function(t,o,e){var n=t({"default":"/consumptions"},[],{forAccountPath:"consumptions",forAccountMethods:"save",forAccountOptions:{saveMethod:"PUT"}});return n.get=function(t,n,r,c){return c=c||"electricity",o.request({method:"GET",url:e.url([this.getPath,t,n,r.join("+")]),params:{metric:c}})},n}])};
