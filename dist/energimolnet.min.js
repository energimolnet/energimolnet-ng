...
module.exports=function(e){e.run(["$window","emAccounts","emClients","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emFtpConnections","emMe","emMeters","emOwners","emPassword","emRefreshTokens","emReports","emRobots","emUsers","emSubaccounts","emDateUtil","energimolnetAPI",function(e,n,o,s,t,m,i,r,c,u,l,p,C,a,f,w,R,g,P){function S(n,o){n.then(function(n){o===!0?e.console.log("Response:\n",n):e.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){e.console.log("Error:\n",n)})}S.Accounts=n,S.Clients=o,S.ConsumptionPreview=s,S.ConsumptionStats=t,S.Consumptions=m,S.Contracts=i,S.FtpConnections=r,S.Meters=u,S.Me=c,S.Owners=l,S.Password=p,S.RefreshTokens=C,S.Reports=a,S.Robots=f,S.Subaccounts=R,S.Users=w,S.DateUtil=g,S.api=P,e.em=S}])};
