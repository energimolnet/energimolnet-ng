...
var makeUrl=require("./util/makeurl"),PATH_TOKEN="oauth/token",PATH_AUTHORIZE="oauth/authorize",PATH_SIGN_IN="security/signin",PATH_SIGN_OUT="security/signout",KEY_PRIVATE_TOKEN="emPrivateToken",KEY_REFRESH_TOKEN="emRefreshToken",KEY_ACCESS_TOKEN="emAccessToken";module.exports=function(e,t,n,r,o){function i(){return s(KEY_PRIVATE_TOKEN)}function u(){return s(KEY_REFRESH_TOKEN)}function c(){return s(KEY_ACCESS_TOKEN)}function a(e){l(e,KEY_PRIVATE_TOKEN)}function _(e){l(e,KEY_REFRESH_TOKEN)}function f(e){l(e,KEY_ACCESS_TOKEN)}function s(t){var n=e.localStorage.getItem(t);return!n||"{"!=n.charAt(0)&&"["!=n.charAt(0)?n:JSON.parse(n)}function l(t,n){if(t&&t.length>0){var r=typeof t;"string"!==r&&"number"!==r&&(n=JSON.stringify(n)),e.localStorage.setItem(n,t)}else e.localStorage.removeItem(n)}function E(){return null!==i()||null!==u()}function T(e){return n(function(t,n){var o=i();if(o)return e.headers={Authorization:"OAuth "+o},void t(e);if(r.disabled)return void t(e);var c=u();return c?void h(c).then(function(n){e.headers={Authorization:"Bearer "+n.access_token},t(e)},function(){n()}):void n()})}function h(e){return n(function(t,n){var r=c();A(r)&&r.refresh_token===e?t(r):(k.push(function(e){e?t(e):n()}),m||(m=!0,d(e).then(function(e){var t=e.data;f(t),m=!1,k.forEach(function(e){e(t)}),k=[]},function(){f(null),m=!1,k.forEach(function(e){e(null)}),k=[]})))})}function A(e){return e&&e.expires_at>Date.now()}function d(e){return t.post(makeUrl([o,PATH_TOKEN]),{client_id:r.clientId,client_secret:r.clientSecret,grant_type:"refresh_token",scope:"basic",refresh_token:e}).then(function(e){return e.expires_at=Date.now()+1e3*e.expires_in,e})}function K(){var e={client_secret:r.clientSecret,client_id:r.clientId,redirect_uri:r.redirectUri,grant_type:"authorization_code",response_type:"code",state:"emAuth",scope:"basic"};return makeUrl([o,PATH_AUTHORIZE],e)}function S(e){return makeUrl([o,PATH_SIGN_IN])+"?redirect="+encodeURIComponent(e)}function N(e){return makeUrl([o,PATH_SIGN_OUT])+"?redirect="+encodeURIComponent(e)}var k=[],m=!1;return{getPrivateToken:i,setPrivateToken:a,getRefreshToken:u,setRefreshToken:_,isAuthenticated:E,loginUrl:S,logoutUrl:N,authorizeUrl:K,authorize:T}};
