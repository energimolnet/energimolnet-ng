...
var makeUrl=require("./util/makeurl"),PATH_TOKEN="oauth/token",PATH_AUTHORIZE="oauth/authorize",PATH_SIGN_IN="security/signin",PATH_SIGN_OUT="security/signout",KEY_PRIVATE_TOKEN="emPrivateToken",KEY_REFRESH_TOKEN="emRefreshToken",KEY_ACCESS_TOKEN="emAccessToken";module.exports=function(e,t,n,r,i){function o(){return f(KEY_PRIVATE_TOKEN)}function c(){return f(KEY_REFRESH_TOKEN)}function u(){return f(KEY_ACCESS_TOKEN)}function a(e){l(e,KEY_PRIVATE_TOKEN)}function s(e){l(e,KEY_REFRESH_TOKEN)}function _(e){l(e,KEY_ACCESS_TOKEN)}function f(t){var n=e.localStorage.getItem(t);return!n||"{"!=n.charAt(0)&&"["!=n.charAt(0)?n:JSON.parse(n)}function l(t,n){if(t&&t.length>0){var r=typeof t;"string"!==r&&"number"!==r&&(n=JSON.stringify(n)),e.localStorage.setItem(n,t)}else e.localStorage.removeItem(n)}function E(){return null!==o()||null!==c()}function T(e){return n(function(t,n){var i=o();if(i)return e.headers={Authorization:"OAuth "+i},void t(e);if(r.disabled)return void t(e);var u=c();return u?void h(u).then(function(n){e.headers={Authorization:"Bearer "+n.access_token},t(e)},function(){n()}):void n()})}function h(e){return n(function(t,n){var r=u();d(r)&&r.refresh_token===e?t(r):(p.push(function(e){e?t(e):n()}),I||(I=!0,A(e).then(function(e){var t=e.data;_(t),I=!1,p.forEach(function(e){e(t)}),p=[]},function(){_(null),I=!1,p.forEach(function(e){e(null)}),p=[]})))})}function d(e){return e&&e.expires_at>Date.now()}function A(e){return t.post(makeUrl([i,PATH_TOKEN]),{client_id:r.clientId,client_secret:r.clientSecret,grant_type:"refresh_token",scope:"basic",refresh_token:e}).then(function(e){return e.expires_at=Date.now()+1e3*e.expires_in,e})}function k(){var e={client_secret:r.clientSecret,client_id:r.clientId,redirect_uri:r.redirectUri,grant_type:"authorization_code",response_type:"code",state:"emAuth",scope:"basic"};return makeUrl([i,PATH_AUTHORIZE],e)}function K(e){return t.post(makeUrl([i,PATH_TOKEN]),{grant_type:"authorization_code",code:e,client_id:r.clientId,client_secret:r.clientSecret,state:"emAuth",scope:"basic",redirect_uri:r.redirectUri}).then(function(e){N.setRefreshToken(e.refresh_token),N.setAccessToken(e.access_token)})}function S(e){return makeUrl([i,PATH_SIGN_IN])+"?redirect="+encodeURIComponent(e)}function m(e){return makeUrl([i,PATH_SIGN_OUT])+"?redirect="+encodeURIComponent(e)}var N=this,p=[],I=!1;return{getPrivateToken:o,setPrivateToken:a,getRefreshToken:c,setRefreshToken:s,isAuthenticated:E,loginUrl:S,logoutUrl:m,authorizeUrl:k,handleAuthCode:K,authorize:T}};
