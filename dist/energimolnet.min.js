...
module.exports=function(n){n.run(["$window","emConsumptionPreview","emConsumptionStats","emConsumptions","emContracts","emMe","emOwners","emPassword","emReports","emUsers","emDateUtil","energimolnetAPI",function(n,o,e,s,t,i,m,r,u,l,p,c){function a(o,e){o.then(function(o){1==e?n.console.log("Response:\n",o):n.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){n.console.log("Error:\n",o)})}a.ConsumptionPreview=o,a.ConsumptionStats=e,a.Consumptions=s,a.Contracts=t,a.Me=i,a.Owners=m,a.Password=r,a.Reports=u,a.Users=l,a.DateUtil=p,a.api=c,n.em=a}])};
