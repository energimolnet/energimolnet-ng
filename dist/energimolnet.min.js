...
var MODULE_NAME="energimolnet",module=angular.module(MODULE_NAME,[]);"object"==typeof module&&(module.exports=MODULE_NAME),module.factory("emDateUtil",function(){return require("./date-util")}).factory("energimolnetAPI",["$http","$window","$q","apiBaseUrl",require("./energimolnet-api")]).factory("emResourceFactory",["energimolnetAPI",require("./resource-factory")]).factory("emAccounts",require("./models/accounts")).factory("emClients",require("./models/clients")).factory("emConsumptionPreview",require("./models/consumption-preview")).factory("emConsumptionStats",require("./models/consumption-stats")).factory("emConsumptions",require("./models/consumptions")).factory("emEdielJobs",require("./models/ediel-jobs")).factory("emFileJobs",require("./models/file-jobs")).factory("emFtpConnections",require("./models/ftp-connections")).factory("emMe",require("./models/me")).factory("emMeters",require("./models/meters")).factory("emOwners",require("./models/owners")).factory("emPassword",require("./models/password")).factory("emRefreshTokens",require("./models/refreshtokens")).factory("emReports",require("./models/reports")).factory("emRobotJobs",require("./models/robot-jobs")).factory("emRobots",require("./models/robots")).factory("emScrapers",require("./models/scrapers")).factory("emSubaccounts",require("./models/subaccounts")).factory("emSubscribers",require("./models/subscribers")).factory("emTokens",require("./models/tokens")).run(require("./debug-util"));
...
var ACCOUNTS_PATH="/accounts";module.exports=function(t){function r(t){function r(){this._config=t}return t.get&&(r.prototype.get=o),t.query&&(r.prototype.query=i),(t.put||t.post)&&(r.prototype.save=n),t.batch&&(r.prototype.batchUpdate=u),t["delete"]&&(r.prototype["delete"]=c),t.forAccount&&(r.prototype.forAccount=a),new r}function e(t,r){var e=t[r];return e===!0?t["default"]:e}function o(r){return t.request({method:"GET",url:e(this._config,"get")+"/"+r})}function n(r){var o,n,u=r;return void 0===r._id&&this._config.post?(o="POST",n=e(this._config,"post")):(o="PUT",n=e(this._config,"put")+"/"+r._id,u=angular.copy(r),delete u._id),t.request({method:o,url:n,data:u})}function u(r,o){for(var n=[],u=0,i=r.length;i>u;u++){var c=angular.copy(o);c._id=r[u],n.push(c)}return t.request({method:"PUT",url:e(this._config,"batch"),data:n})}function i(r){return t.request({method:"GET",url:e(this._config,"query"),params:f(r)})}function c(r){return t.request({method:"DELETE",url:e(this._config,"delete")+"/"+r})}function a(t){var e=angular.copy(this._config.forAccount);return["default","get","put","post","delete","query"].forEach(function(r){var o=e[r];"string"==typeof o&&"/"!==o[0]&&(e[r]="/accounts/"+t+"/"+o)}),r(e)}function f(t){var r={};for(var e in t)if(t.hasOwnProperty(e)){var o=t[e],n=angular.isString(o);null!=o&&(n&&o.length>0||!n)&&(r[e]=o)}return r}return r};
