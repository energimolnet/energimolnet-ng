...
module.exports=function(o,n,s,e,t,i,r,c,u,l,p,b,a,f,R,m,C,S,g,J,d,h,w,k){function E(n,s){n.then(function(n){s===!0?o.console.log("Response:\n",n):o.console.log("Response:\n",JSON.stringify(n,null,2))},function(n){o.console.log("Error:\n",n)})}E.Accounts=n,E.Clients=s,E.ConsumptionPreview=e,E.ConsumptionStats=t,E.Consumptions=i,E.EdielJobs=r,E.FileJobs=c,E.FtpConnections=u,E.Meters=p,E.Me=l,E.Owners=b,E.Password=a,E.RefreshTokens=f,E.Reports=R,E.RobotJobs=m,E.Robots=C,E.Scrapers=S,E.Subaccounts=g,E.Subscribers=J,E.Tokens=d,E.DateUtil=h,E.api=w,E.auth=k,o.em=E};
