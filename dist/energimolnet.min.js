...
module.exports=function(e){e.factory("emRobots",["emResourceFactory","emUrl","energimolnetAPI",function(e,t,r){var o=e({"default":"/robots"},["get","query","save","delete"]);return o.run=function(e){r.request({url:t.url([this.getPath,e,"run"]),method:"POST"})},o}])};
