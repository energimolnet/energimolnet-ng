...
module.exports=function(o,s,e,n,t,i,c,l,r,u,a,p,b,R,d,f,C,S,m,M,g,J,h,F,k,w,E,O){function T(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}T.Accounts=s,T.Clients=e,T.Complaints=n,T.CalculatedMetrics=t,T.ConsumptionStats=i,T.Consumptions=c,T.EdielJobs=l,T.Feeds=r,T.FileJobs=u,T.FtpConnections=a,T.Me=p,T.Meters=b,T.MetricModels=R,T.Owners=d,T.Password=f,T.RefreshTokens=C,T.Reports=S,T.RobotJobs=m,T.RobotStats=M,T.Robots=g,T.Scrapers=J,T.Subaccounts=h,T.Subscribers=F,T.Tokens=k,T.DateUtil=w,T.api=E,T.auth=O,o.em=T};
